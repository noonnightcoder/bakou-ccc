...
class EmployeeController extends Controller
{
                ...
                if ($valid) {
                    ...
                    try {
                        if ($model->save()) {
                            ...
                            if ($user->save()) {
                                $assignitems = array('items','sizes', 'colors','barcode','employees', 'store', 'reports');
    ...
    public function actionUpdate($id)
    {
        ...
        if (Yii::app()->user->checkAccess('employee.update')) {
            ...
            $user->sizes = $auth_items;
            $user->colors = $auth_items;
            $user->barcode = $auth_items;
                    ...
                    try {
                        if ($model->save()) {
                            ...
                            if ($user->save()) {
                                ...
                                $assignitems = array('items','sizes','barcode','colors','employees', 'store', 'reports');
